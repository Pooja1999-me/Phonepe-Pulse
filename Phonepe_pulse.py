...
icon = Image.open(r"D:/Guvi/Phonepe_Pulse_Data_Visualization_and_Exploration/phonepe_img.png")
st.set_page_config(page_title= "Phonepe Pulse Data Visualization",
                   page_icon= icon,
                   layout= "wide",
                   initial_sidebar_state= "expanded",
                   menu_items={'About': """# This Data has been cloned from Phonepe Pulse Github Repo"""})
...
# EXPLORE DATA - TRANSACTIONS
    if Type == "Transactions":
        ...
        with col1:
            ...
            df2 = pd.read_csv(r'D:/Guvi/Phonepe_Pulse_Data_Visualization_and_Exploration/pulse/data/Statenames.csv')
            df1.State = df2
